...
export default function GradientTestCard() {
  return (
    <div className="relative w-full max-w-xl mx-auto mt-10 rounded-xl overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[conic-gradient(var(--tw-gradient-stops))] from-amber-400 via-pink-500 to-amber-400 blur-md opacity-70" />

      {/* animated gradient border on top */}
      <div
        className="pointer-events-none absolute inset-0 animate-spin-slow bg-[conic-gradient(var(--tw-gradient-stops))] from-amber-400 via-pink-500 to-amber-400 blur-xl opacity-95 z-10"
