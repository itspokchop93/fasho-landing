-- Active Users Tracking Tables for Real-time Admin Dashboard
-- This migration creates tables to track active users and daily visit statistics
...
CREATE INDEX IF NOT EXISTS idx_active_users_ip_address ON active_users(ip_address);
CREATE INDEX IF NOT EXISTS idx_active_users_last_activity ON active_users(last_activity);
CREATE INDEX IF NOT EXISTS idx_active_users_is_guest ON active_users(is_guest);
CREATE INDEX IF NOT EXISTS idx_active_users_current_page ON active_users(current_page);

CREATE INDEX IF NOT EXISTS idx_daily_visits_date ON daily_visits(date);
CREATE INDEX IF NOT EXISTS idx_daily_visits_ip_address ON daily_visits(ip_address);
CREATE INDEX IF NOT EXISTS idx_daily_visits_is_unique ON daily_visits(is_unique);

-- Composite index for daily visit lookups
CREATE INDEX IF NOT EXISTS idx_daily_visits_date_ip ON daily_visits(date, ip_address);

-- Update trigger for daily_visits
